...
def __change_gnome_settings_to_my():
    ...
    os.system(r'gsettings set org.gnome.desktop.session idle-delay 0')
    os.system(r'gsettings set org.gnome.desktop.screensaver lock-enabled false')
    os.system(r'gsettings set org.gnome.desktop.notifications show-in-lock-screen false')
    os.system(r'gsettings set org.gnome.desktop.interface clock-show-seconds true')
